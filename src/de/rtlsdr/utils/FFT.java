...
public final class FFT {
   ...
   * @param sign -1 is FFT, 1 is IFFT (inverse FFT)
   */
  ...
  // Perform Factor-4 Decomposition with 3 * complex operators
  // and 8 +/- complex operators
  private final static void calcF4F(int fftFrameSize, double[] data, int i, int nstep, double[] w) {
    ...
    while (nstep < fftFrameSize2) {
      ...
      for (int j = 2; j < jmax; j += 2) {
        ...
        // these numbers can be precomputed!!!
  ...
  // Perform Factor-4 Decomposition with 3 * complex operators and 8 +/- complex
  // operators
